...
// Footer global do site (3 colunas: logo+desc+redes, links úteis, newsletter+empresa).
// Fica oculto em rotas standalone como /bio, que não devem exibir o chrome do site.
const HIDDEN_ROUTES = ["/bio"]
