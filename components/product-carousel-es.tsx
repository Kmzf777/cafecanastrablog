...
// Fuentes premium sugeridas (agregar en _document.tsx o vía Google Fonts):
// 'Playfair Display' para títulos, 'Inter' para textos

const products = [
  {
    name: "Canastra Clásico",
    description:
      "Café 100% Arábica – Tipo Especial +80 SCA. Torra oscura intensidad 8 y molienda medio-fina, ideal para filtro. Con cuerpo con notas caramelizadas y achocolatadas.",
    image: "/cafe-classico.png",
    imageAlt: "Foto del Canastra Clásico",
    gradient: "radial-gradient(circle at 60% 55%, #232526 0%, #414345 100%)",
    textColor: "text-white/90",
    properties: [4, 3, 5, 5],
    propertyLabels: ["Dulzura", "Acidez", "Cuerpo", "Amargor"],
  ...
  },
  {
    name: "Canastra Suave",
    description:
      "Café 100% Arábica – Tipo Especial +80 SCA. Torra media intensidad 7 y molienda medio-fina, ideal para filtro. Con cuerpo con notas achocolatadas y finalización cítrica.",
    image: "/cafe-suave.png",
    imageAlt: "Foto del Canastra Suave",
  ...
  },
  {
    ...
    description:
      "Café 100% Arábica – Tipo Especial +80 SCA. Torra oscura intensidad 7. Con cuerpo con notas caramelizadas y agregado con canela natural.",
    image: "/cafe-canela.png",
    imageAlt: "Foto del Canastra Canela",
  ...
  },
  {
    ...
    description:
      "Café 100% Arábica Especial con 86 puntos SCA. Medio cuerpo, notas de cacao, melaza y finalización suavemente cítrica.",
    image: "/microlote-png.png",
    imageAlt: "Foto del Microlote",
...
export default function ProductCarouselEs({ scrollToSection }: { scrollToSection?: (id: string) => void }) {
  useEffect(() => {
    // Personalizar botones del Swiper para minimalismo
      ...
      >
        {products.map((product) => (
          <SwiperSlide key={product.name}>
            ...
            >
              {/* Título del producto - esquina superior izquierda, responsivo, nunca pegado */}
              <div
              ...
              {/* Imagen centrada, responsiva, nunca cortada */}
              <div
                ...
                >
                  <p
                    ...
                    style={{
                      ...
                      color: product.name === 'Canastra Clásico' ? 'rgba(255,255,255,0.9)' : 
