...
export default function HomeClient({ blogSection }: HomeClientProps) {
  ...
  // Faqs importados de site-config
  const faqs = FAQS
  ...
  const scrollToSection = (id: string) => handleNavigation({ id })
  ...
  const navigationItems = [
    ...
    { name: "Blog", id: "blog-link", href: "/blog" },
