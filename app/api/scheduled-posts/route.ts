...
export async function POST(request: Request) {
  try {
    console.log("=== GATILHO DE POST AUTOMÁTICO RECEBIDO ===")
    ...
    return NextResponse.json({
      success: true,
      message: `Gatilho processado com sucesso. ${createdPosts} post(s) criado(s).`,
...
export async function GET() {
  return NextResponse.json({
    message: "Endpoint de gatilho automático está funcionando",
