...
export default function CafeCanastraWebsite() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      {/* Fixed Navigation */}
      <motion.nav
        className={`fixed top-0 w-full z-50 transition-all duration-300 ${isMenuScrolled ? "bg-white shadow-lg" : "bg-transparent"
          }`}
        initial={{ y: -100 }}
        animate={{ y: 0 }}
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <img
                ...
                alt="Café Canastra"
                className={`h-8 sm:h-10 w-auto transition-all duration-300 ${isMenuScrolled ? "filter-none" : "filter brightness-0 invert"
                  }`}
              />
            </div>
            ...
            <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
              {[
                ...
                <button
                  ...
                  className={`transition-colors hover:text-amber-600 text-sm xl:text-base ${isMenuScrolled ? "text-gray-800" : "text-white"
                    }`}
                >
                  {item.name}
                </button>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left bg-white p-8 rounded-2xl shadow-md border border-amber-100">
              <div className="space-y-4">
                ...
                <div className="flex justify-between border-b border-gray-100 pb-2">
                  <span className="font-semibold text-gray-700">Altitud</span>
                  <span className="text-gray-600">1250m</span>
                </div>
                <div className="flex justify-between border-b border-gray-100 pb-2">
                  <span className="font-semibold text-gray-700">Temperatura Media</span>
                  <span className="text-gray-600">26ºC</span>
                </div>
              </div>
              <div className="space-y-4">
                <div className="flex justify-between border-b border-gray-100 pb-2">
                  <span className="font-semibold text-gray-700">Latitud</span>
            ...
            <Card className="shadow-lg">
              <CardContent className="p-6 sm:p-8">
                ...
                <form onSubmit={handleFormSubmit} className="space-y-6">
                  ...
                  {submitMessage && (
                    <div className={`p-3 rounded-lg text-sm ${submitMessage.includes("éxito")
