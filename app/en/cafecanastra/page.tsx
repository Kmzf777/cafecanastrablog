...
const FarmMap = dynamic(() => import("@/components/FarmMap"), {
  ssr: false,
  loading: () => <div className="w-full h-full bg-amber-50 animate-pulse flex items-center justify-center text-amber-800">Loading Map...</div>
})
            ...
            <Card className="shadow-lg">
              <CardContent className="p-6 sm:p-8">
                ...
                <form onSubmit={handleFormSubmit} className="space-y-6">
                  ...
                  {submitMessage && (
                    <div className={`p-3 rounded-lg text-sm ${submitMessage.includes("successfully")
